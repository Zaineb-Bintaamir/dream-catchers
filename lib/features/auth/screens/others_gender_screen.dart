...
class OthersGenderScreen extends GetView<RegistrationController> {
  const OthersGenderScreen({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemCount: Genders.allGenders.length - 2,
                        itemBuilder: (context, index) {
                          final String gender = Genders.allGenders[index + 2];
                          return Obx(
                            () => SignupSelectOptionWidget(
                              text: gender,
                              isSelected:
                                  controller.selectedGender.value == gender,
                              onSelect: () => controller.selectGender(gender),
                            ),
                          );
                        },
                      ),
